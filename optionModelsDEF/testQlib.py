...
todaysDate=Date(2,January,2019)
Settings.instance().evaluationDate = todaysDate
#settlementDate = Date(17,May,1998)
settlementDate = Date(3,January,2019)
riskFreeRate = FlatForward(settlementDate, 0.10, Actual365Fixed())

# option parameters
#exercise = AmericanExercise(settlementDate, Date(17,May,1999))
exercise = AmericanExercise(settlementDate, Date(3,January,2020))
payoff = PlainVanillaPayoff(Option.Put, 100.0)

# market data
underlying = SimpleQuote(100.0)
volatility = BlackConstantVol(todaysDate, TARGET(), 0.30, Actual365Fixed())
